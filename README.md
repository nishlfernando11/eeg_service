...
- If need, create a new conda environment
- Install: `pip install -r requirements.txt`
- If Emotiv headset is running, start program with `python main.py`

**Emotiv has exclusive rights to the code files except main.py.

## Before you start set up Emotiv (Extracted from Emotiv Cortex API documentatio))
